...
//	  cause.printStackTrace();
  ...
  public void messageArrived(String topic, MqttMessage message) throws Exception {
    ...
    byte[] EncMessage = Notify.encdec(message.getPayload(),true);
    byte[] DecMessage = Notify.encdec(EncMessage,false);
    //args[0] = new String(message.getPayload());
    args[0]= "Original Data : \n"+ Notify.toHex(message.getPayload()) + "\n" + "Encrypted Data : \n" + Notify.toHex(EncMessage) + "\n"+ "Decrypted Data : \n" + Notify.toHex(DecMessage) +"\n";
